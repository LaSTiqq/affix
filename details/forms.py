...
class ContactForm(forms.Form):
    name = forms.CharField(label='Vārds', widget=forms.TextInput(attrs={
                           'class': 'form-control bg-transparent ms-auto mt-2', 'placeholder': 'Vārds', 'autocomplete': 'off', 'required': True, 'maxlength': '15'}))
    ...
    subject = forms.CharField(label='Temats', widget=forms.TextInput(
        attrs={'class': 'form-control bg-transparent ms-auto mt-2', 'placeholder': 'Temats', 'autocomplete': 'off', 'required': True, 'maxlength': '30'}))
